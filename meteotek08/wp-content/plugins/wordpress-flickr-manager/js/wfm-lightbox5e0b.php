...
function prepareWFMImages() {
	...
	wfmJS('a[@rel*=flickr-mgr]').click(function() {
		...
		if('' == 'true') caption = wfmJS(this).attr('title') + ' <a href="' + wfmJS(this).attr('href') + '" title="View on Flickr"><img src="http://teslabs.com/meteotek08/wp-content/plugins/wordpress-flickr-manager/images/flickr-media.gif" alt="View on Flickr" /></a>';
		...
		if(wfmJS(this).attr("rel") == "flickr-mgr") {	// Individual Photo
			...
			wfmJS(this).lightbox({
				...
				fileLoadingImage:	"http://teslabs.com/meteotek08/wp-content/plugins/wordpress-flickr-manager/images/loading-3.gif",
				fileBottomNavCloseImage:	"http://teslabs.com/meteotek08/wp-content/plugins/wordpress-flickr-manager/images/closelabel.gif"
			});
